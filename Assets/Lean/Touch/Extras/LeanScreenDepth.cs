                    ...
                    case ConversionType.PlaneIntercept:
                        {
                            ...
                            if (Exists(gameObject, ref plane) == true)
                            {
                                ...
                                if (plane.TryRaycast(ray, ref hit, Distance) == true)
                                {
                                    ...
                                    Debug.DrawLine(ray.origin, ray.GetPoint(100), Color.green, 0.1f);
                                    Debug.DrawLine(ray.origin, hit, Color.red, 0.1f);
                                    Debug.DrawLine(ray.origin, plane.transform.forward, Color.yellow, 0.1f);
