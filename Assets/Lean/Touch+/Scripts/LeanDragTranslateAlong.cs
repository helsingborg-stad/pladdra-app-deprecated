...
namespace Lean.Touch
{
    ...
    [ExecuteInEditMode]
    [HelpURL("Pladdra " + "LeanDragTranslateAlong")]
    [AddComponentMenu("Pladdra " + "Drag Translate Along")]
    public class LeanDragTranslateAlong : MonoBehaviour
    {
        ...
        [FSA("Target")] [SerializeField] private Transform target;
        ...
        [FSA("TrackScreenPosition")] [SerializeField] private bool trackScreenPosition = true;
